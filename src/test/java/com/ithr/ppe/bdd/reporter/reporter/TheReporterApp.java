...
import com.ithr.ppe.bdd.reporter.reporter.LoadReportProperties;
import com.ithr.ppe.bdd.reporter.reporter.PPEConfiguration;
import com.ithr.ppe.bdd.reporter.reporter.PPEReportBuilder;

public class TheReporterApp 
{
	...
	public static Logger log = Logger.getLogger(TheReporterApp.class);
